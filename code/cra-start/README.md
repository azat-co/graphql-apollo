...
We commit to keeping the breaking changes minimal so you can help `react-scripts` painlessly.
...
```js
{
  ...
  "proxy": {
    "/socket": {
      ...
      // https://github.com/chimurai/http-proxy-middleware#external-websocket-help
      "ws": true
      // ...
    }
  }
